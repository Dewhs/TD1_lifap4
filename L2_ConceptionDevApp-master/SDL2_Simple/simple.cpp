...
SDLSimple::SDLSimple() : m_window(nullptr), m_renderer(nullptr), m_font(nullptr)
{
    ...
    // IMAGES
    m_image.loadFromFile("pacman.png",m_renderer);

    // FONTS
    m_font = TTF_OpenFont("DejaVuSansCondensed.ttf",50);
    if (m_font == NULL) {
...
void SDLSimple::sdlAff () 
{
    ...
    //cout<<t<<endl;
	m_image.draw(m_renderer, 320-50-50*t, 200-50-50*t, 100+t*100, 100+t*100 );
